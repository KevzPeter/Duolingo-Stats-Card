                ...
                <div xmlns="http://www.w3.org/1999/xhtml">
                        <div className="card" style={{'background-color': `${themes[theme].background}`, 'color': `${themes[theme].colorPrimary}`}}>
                            <div className='content'>
                                <div className='stats'>
                                    <span id="streak"><Streak height={40} width={40}  viewBox="0 0 250 283"/>{response.streak} Day streak</span>
                            ...
                            <Duo_Waving height={152} width={122}  viewBox="0 0 281 349"/>
                            {/* <Duo_PencilBoarding height={155} width={155}  viewBox="0 0 300 300"/> */}
                        </div>
                </div>
            </foreignObject>
        </g>
